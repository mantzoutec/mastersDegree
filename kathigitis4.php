        ...
        <div class="jumbotron">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-md-2">
                    <img src="photos/kathigitis_4.jpg" class="rounded" width="150" alt="Καθηγητής ΕΑΠ Μαίρη Κοστίνου">
                </div>
                <div class="col-sm-12 col-md-9">
                    <h4>
                        <strong>Μαίρη Κοστίνου</strong>
                    </h4>
                    <hr>
                    <h5>Θέση:</h5>
                    <p>
                        Καθηγήτρια, Τμήμα Πληροφορικής & Τηλεπικοινωνιών, Σχολή Πληροφορικής & Τηλεπικοινωνιών
                    </p>
                    <hr>
                    ...
                    <p>
                        Πανεπιστήμιο Πατρών, Μοντελοποίηση & Ιεραρχικός Ευφυής Έλεγχος Συστημάτων με Ασαφή Γνωστικά
                        Δίκτυα
                    </p>
                    </p>
                </div>
