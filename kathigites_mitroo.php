    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col offset-5">
                <h6>
                    <strong>ΦΟΡΜΑ ΕΠΕΞΕΡΓΑΣΙΑΣ ΚΑΘΗΓΗΤΗ</strong>
                </h6>
            </div>
        </div>
        <br>
        <br>
        <form name="userEdit" action="kathigites_mitroo_help.php" method="POST" onSubmit="return validate()">
            ...
            <div class="row">
                <div class="col-10 offset-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="role" class="form-control" id="role" value="Καθηγητής" disabled>
                        </div>
                    </div>
                </div>
            </div>
