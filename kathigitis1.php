        ...
        <div class="jumbotron">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-md-2">
                    <img src="photos/kathigitis_1.jpg" class="rounded" width="150" alt="Καθηγητής ΕΑΠ Ιωάννης Ιακώβου">
                </div>
                <div class="col-sm-12  col-md-9">
                    <h4>
                        <strong>Ιωάννης Ιακώβου</strong>
                    </h4>
                    <hr>
                    <h5>Θέση:</h5>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Philosophy and Ethics of AI</li>
                    </ul>
                    </p>
                    <hr>
                    ...
                    <p>
                        Πανεπιστήμιο Πατρών, Τμήμα Μαθηματικών Τομέας Υπολογιστικών Μαθηματικών και Πληροφορικής
                    </p>
                    </p>
                </div>
            </div>
