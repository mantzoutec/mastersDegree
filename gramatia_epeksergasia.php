...
<!DOCTYPE html>
    ...
    <body>
        ...
        <?php
            include 'conn.php';
            $select = $con->query("SELECT * FROM user ORDER BY role, surname;");
            $con->close();
        ?>
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=""><?= $row[9] ?></td>
                            <td class=""><?= $row[10] ?></td>
                            <form name="dbusrform" action="gramatia_del_edit_user.php">
        ...
        <script>
                ...
                let x = confirm("Θέλετε να διαγραφεί ο χρήστης;");
                if (x)
                    return true;
                else
                    return false;
                ...
                let x = confirm("Θέλετε να τροποποιήσετε τα στοιχεία του χρήστη;");
                if (x)
                    return true;
                else
                    return false;
