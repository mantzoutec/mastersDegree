        ...
        <div class="jumbotron">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-md-2">
                    <img src="photos/kathigitis_3.jpg" class="rounded" width="150" alt="Καθηγητής ΕΑΠ Κωνσταντίνος Ευσταθίου">
                </div>
                <div class="col-sm-12 col-md-9">
                    <h4>
                        <strong>Κωνσταντίνος Ευσταθίου</strong>
                    </h4>
                    <hr>
                    <h5>Θέση:</h5>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Multi-Agent Systems and Game Theory</li>
                    </ul>
                    </p>
                    <hr>
                    ...
                    <p>
                        Πανεπιστήμιο Πατρών, Γραφικά και Επεξεργασία Εικόνας DEA Traitement Graphique- Traitement
                        d’Images
                    </p>
                    </p>
                </div>
